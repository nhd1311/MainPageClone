 const translations = {
  vi: {
    ...
    tabBar: {
      ...
      expand:      'Extend',
      industries: [
        { key: 'agriculture',   label: 'Sản xuất Nông - Lâm - Ngư nghiệp' },
        { key: 'mining',        label: 'Khai khoáng' },
        { key: 'utilities',     label: 'Tiện ích cộng đồng' },
        { key: 'construction',  label: 'Xây dựng và bất động sản' },
        { key: 'manufacturing', label: 'Sản xuất' },
        { key: 'transport',     label: 'Vận tải và kho bãi' },
        { key: 'tech',          label: 'Công nghệ - Truyền thông' },
        { key: 'finance',       label: 'Tài chính và bảo hiểm' },
        { key: 'rental',        label: 'Thuê và cho thuê' },
        { key: 'professional',  label: 'Dịch vụ chuyên môn - Khoa học - Kỹ thuật' },
        { key: 'support',       label: 'Dịch vụ hỗ trợ - Dịch vụ xử lý và tái chế rác thải' },
        { key: 'education',     label: 'Giáo dục và đào tạo' },
        { key: 'healthcare',    label: 'Dịch vụ chăm sóc sức khỏe' },
        { key: 'arts',          label: 'Nghệ thuật và dịch vụ giải trí' },
        { key: 'accommodation', label: 'Dịch vụ lưu trú và ăn uống' },
        { key: 'publicAdmin',   label: 'Hành chính công' },
        { key: 'otherServices', label: 'Dịch vụ khác' },
  ...
  en: {
    ...
    tabBar: {
      ...
      expand:      'Extend',
      industries: [
        { key: 'agriculture',   label: 'Agriculture Production' },
        { key: 'mining',        label: 'Mining, Quarrying, and Oil and Gas Extraction' },
        { key: 'utilities',     label: 'Utilities' },
        { key: 'construction',  label: 'Construction and Real Estate' },
        { key: 'manufacturing', label: 'Manufacturing' },
        { key: 'transport',     label: 'Transportation and Warehousing' },
        { key: 'tech',          label: 'Information and Technology' },
        { key: 'finance',       label: 'Finance and Insurance' },
        { key: 'rental',        label: 'Rental and Leasing' },
        { key: 'professional',  label: 'Professional, Scientific, and Technical Services' },
        { key: 'support',       label: 'Administrative and Support and Waste Management and Remediation Services' },
        { key: 'education',     label: 'Educational Services' },
        { key: 'healthcare',    label: 'Health Care and Social Assistance' },
        { key: 'arts',          label: 'Arts, Entertainment, and Recreation' },
        { key: 'accommodation', label: 'Accommodation and Food Services' },
        { key: 'publicAdmin',   label: 'Public Administration' },
        { key: 'otherServices', label: 'Orther Services' },
        { key: 'wholesale',     label: 'Wholesale Trade' },
